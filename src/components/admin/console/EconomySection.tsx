...
import { BulkProfileConsolidation } from "../BulkProfileConsolidation";

export function EconomySection() {
  return (
    <Tabs defaultValue="resgates" className="w-full">
      <TabsList className="grid w-full md:w-auto grid-cols-7 gap-1">
        ...
        <TabsTrigger value="bulk-consolidacao">Lote</TabsTrigger>
      </TabsList>
      ...
      <TabsContent value="bulk-consolidacao" className="space-y-4">
        <BulkProfileConsolidation />
      </TabsContent>
    </Tabs>
  );
}
